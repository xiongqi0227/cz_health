...
//    static final String accessKeySecret = "B3BZSQDnuUnfZXf22bbovyPaJmCNDt";
    static final String accessKeyId = "LTAI4G4SBbopmSawJcdLroSf";//
    static final String accessKeySecret = "dgap5mZus7WS9JNCoEdntj3lUeOn8K";
    ...
    public static SendSmsResponse sendSms(String telephone, String code ) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("传智健康后台管理系统");			//老袁a洗脚6
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_199217747"); 	//SMS_85550034
